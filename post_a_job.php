...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="item2">
        <div class="job-post">
          <h3 class="head-post">Job Post Section</h3>
          <form action="">
            <fieldset>
              ...
              <div class="experience">
                ...
                <div class="max-exp">
                  ...
                  <select name="maximum-experience" id="maximum-experience">
                    <option value="" selected=""> </option>
                    <option value="to 0">0</option>
                    <option value="to 1">1</option>
                    <option value="to 2">2</option>
                    <option value="to 3">3</option>
                    <option value="to 4">4</option>
                    <option value="to 5">5</option>
                    <option value="to 6">6</option>
                    <option value="to 7">7</option>
                    <option value="to 8">8</option>
                    <option value="to 9">9</option>
                    <option value="to 10">10</option>
                    <option value="to 11">11</option>
                    <option value="to 12">12</option>
                    <option value="to 13">13</option>
                    <option value="to 14">14</option>
                    <option value="to 15">15</option>
                    <option value="to 16">16</option>
                    <option value="to 17">17</option>
                    <option value="to 18">18</option>
                    <option value="to 19">19</option>
                    <option value="to 20">20</option>
                    <option value="to 21">21</option>
                    <option value="to 22">22</option>
                    <option value="to 23">23</option>
                    <option value="to 24">24</option>
                    <option value="to 25">25</option>
                    <option value="to 26">26</option>
                    <option value="to 27">27</option>
                    <option value="to 28">28</option>
                    <option value="to 29">29</option>
                    <option value="to 30">30</option>
                    <option value="to 31">Above 30</option>
                  </select>
                </div>
              </div>
              <div class="salary">
            ...
            <fieldset class="company-section-input">
              ...
              <div class="company-add">
                ...
                <textarea id="companyAddress" name="company-add" class="widgEditor nothing">Enter Company Address...</textarea>
              </div>
